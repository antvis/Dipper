...
export function ActivityTask() {
  const selecticon =
    'https://gw.alipayobjects.com/mdn/rms_58ab56/afts/img/A*kyI9T7Lrej4AAAAAAAAAAAAAARQnAQ';
  const emptyicon =
    'https://gw.alipayobjects.com/mdn/rms_58ab56/afts/img/A*H9dxSp69pi0AAAAAAAAAAAAAARQnAQ';
      ...
      <div>
        <div style={{ margin: '0 20px 20px' }}>
          {selectFeatures.length >= 2 && (
            <Alert message={alertMsg} type="warning" showIcon />
          )}
        </div>
              ...
              selectActivityItem.map((item) => {
                return (
                  ...
                  >
                    ...
                    {current === item.value && (
                      <img className={style.selecticon} src={selecticon} />
                    )}
                  </div>
                );
              })}
